...
public class Utils
{
	...
	/**
	 * Helper method for going through and parsing a CSV file. This uses a lookahead regular expression statement to break 
	...
	public static void writeStringToRaf(String sVal, int nMaxSize, RandomAccessFile obRaf) throws IOException
	{
		...
		// used to writes bytes out.
		// Additionally, there is a string method called getBytes which returns an array of bytes
